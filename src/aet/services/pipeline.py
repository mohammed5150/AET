...
# Payload-agnostic on purpose: the pipeline inspects only a stage's status
# and diagnostics, never its payload, and Outcome[T] is invariant because
# Outcome.ok takes T as a parameter.
StageStep = Callable[[str], Outcome[Any]]
